use crate::{
    ...
    MINT_DECIMALS, SEED_COLLATERAL_ACCOUNT, SEED_CONFIG_ACCOUNT, SEED_MINT_ACCOUNT,
    SEED_SOL_ACCOUNT,
};
...
pub struct DepositCollateralAndMintTokens<'info> {
    ...
    pub sol_account: SystemAccount<'info>, //systemaccount because we need to transfer lamports to it
    #[account(
    mut,
